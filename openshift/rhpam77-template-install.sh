...
rm -f keystore.jks
keytool -noprompt -genkeypair -alias jboss -keypass mykeystorepass -keyalg RSA -keystore keystore.jks -storepass mykeystorepass --dname "CN=jsmith,OU=Engineering,O=mycompany.com,L=Raleigh,S=NC,C=US"
